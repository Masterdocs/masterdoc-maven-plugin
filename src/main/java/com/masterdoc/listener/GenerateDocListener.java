...
public class GenerateDocListener {
	...
	public GenerateDocListener(String packageDocumentationResource) {
		...
		startGeneration(new String[] { this.packageDocumentationResource });
	}
	...
	private Map<String, AbstractEntity> extractFields(Serializable entity)
		...
		System.out
				.println(">>Extract fields for class " + entityClass + " ...");
		...
		for (int i = 0; i < declaredFields.length; i++) {
			...
			try {
				...
				try {
					...
					System.out
							.println(entity.toString() + " is not forNamable");
					continue;
				}
				...
				try {
					...
					System.out.println(">>>>Bypass : " + entityClass.toString()
